...
void test_encodeConnect() {
  ...
  Packet* packet = new Packet(cleanSession,
                              username,
                              password,
                              willTopic,
                              willRemain,
...
void test_encodePublish() {
  ...
  Packet* packet = new Packet(topic,
                              payload,
                              payloadLength,
                              qos,
                              retain,
...
void test_encodePubAck() {
  ...
  Packet* packet =new Packet(PacketType.PUBACK, packetId);
...
void test_encodePubRec() {
  ...
  Packet* packet =new Packet(PacketType.PUBREC, packetId);
...
void test_encodePubRel() {
  ...
  Packet* packet =new Packet(PacketType.PUBREL, packetId);
...
void test_encodePubComp() {
  ...
  Packet* packet =new Packet(PacketType.PUBCOMP, packetId);
...
void test_encodeSubscribe() {
  ...
  Packet* packet =new Packet(topic, qos, packetId);
...
void test_encodePingReq() {
  ...
  Packet* packet = new Packet(PacketType.PINGREQ);
